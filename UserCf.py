...
if __name__ == '__main__':
    ...
    file_name = "E:\\data\\ml-100k\\u.item"
    movies = getMoviesList(file_name)
    # print(movies)
    ...
    #         print(f)
    user_id = 179
    recommend_list, user_movie, items_movie, neighbors = recommendByUserFC("E:\\data\\ml-100k\\u.data", user_id, 80)

    # print(recommend_list,user_movie)
    ...
    print("recommend for user id {}".format(str(user_id)))
    print(rows)
    # # table.add_rows(rows)
    # # print
    # # table.draw()
